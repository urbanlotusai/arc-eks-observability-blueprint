...
# Default target
help:
	@echo "Arc EKS Observability Blueprint - Makefile"
	@echo ""
	@echo "Usage:"
	...
	@echo "  make build-sample  Print instructions to build/push the sample app image"
	@echo ""
	@echo "Variables:"
...
# Build the sample app container image (no zip/npm build for this blueprint —
# the sample app deploys as a Docker image onto the EKS cluster)
build-sample:
	@echo "This blueprint's sample app is a Docker image, not a zip artifact."
	@echo "Build and push it manually, e.g.:"
	@echo "  IMAGE=<your-registry>/arc-eks-observability-sample:latest"
	@echo "  docker build -t \$$IMAGE sample-app/"
	@echo "  docker push \$$IMAGE"
	@echo "See sample-app/README.md for the full deploy walkthrough."
